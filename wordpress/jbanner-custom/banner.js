    ...
    */
    ...
    var pallet = new Array ("aqua", "black", "blue", "fuchsia", "gray", "green", "lime", "maroon", "navy", "olive", "purple", "red", "silver", "teal", "white", "yellow", "orange");
...
function cloneCanvas(oldCanvas) {
    ...
    function changeFontsizeVariable (widget, val) {
     ...
     $( widget ).slider({
      ...
      function addTextBox (textnum, txt) {
        $("#text").append("<div id='text"+textnum+"' class='display-text'></div>");
	...
	textbox += "</td>";
        ...
        $("#text"+textnum).html($("#textbox_"+textnum+" input").attr('value'));
	...
	onChange: function (hsb, hex, rgb) {
		$('#textcolour'+target+' div').css('background-color', '#' + hex);
		$('#text'+target).css('color', '#' + hex);
	...
	$("#text"+$(this).parent().parent().parent().parent().attr('value')).css('color', $(this).css('background-color'));
     ...
     function makeColourSelector (widget) {
        var colourcode = "<div class='sample-colours'><ul>";
     ...
     function setBackgroundHeight (val) {
      ...
      /*
        ...
        */
        ...
        buildGrids(10*(10*upscale), '#eeeeee', 100*(10*upscale),'gridlines');
 ...
 /*       }*/
      ...
      function setBannerSize (size) {
        ...
        if (overscale == true) {
        	...
        	buildGrids(upscale*100, '#eeeeee', 100,'gridlines');
        }
      }
